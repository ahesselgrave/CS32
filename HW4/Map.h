...
template<typename KeyType, typename ValueType> Map<KeyType, ValueType>::Map()
 : m_size(0)
{
      // create dummy node
    m_head = new Node;
...
template<typename KeyType, typename ValueType> Map<KeyType, ValueType>::Map(const Map<KeyType, ValueType>& other)
 : m_size(other.m_size)
{
...
template<typename KeyType, typename ValueType> Map<KeyType, ValueType>& Map<KeyType, ValueType>::operator=(const Map<KeyType, ValueType>& rhs) //Testing
{
    if (this != &rhs)
    {
...
template<typename KeyType, typename ValueType> bool Map<KeyType, ValueType>::erase(const KeyType& key)
{
    Node* p = find(key);
...
template<typename KeyType, typename ValueType> bool Map<KeyType, ValueType>::get(const KeyType& key, ValueType& value) const
{
    Node* p = find(key);
    if (p == m_head)  // not found
        return false;
...
template<typename KeyType, typename ValueType> bool Map<KeyType, ValueType>::get(int i, KeyType& key, ValueType& value) const
{
    if (i < 0  ||  i >= m_size)
        return false;
...
template<typename KeyType, typename ValueType> void Map<KeyType, ValueType>::swap(Map<KeyType, ValueType>& other)
{
      // swap head pointers
...
template<typename KeyType, typename ValueType> typename Map<KeyType, ValueType>::Node* Map<KeyType, ValueType>::find(const KeyType& key) const
{
...
template<typename KeyType, typename ValueType> bool Map<KeyType, ValueType>::doInsertOrUpdate(const KeyType& key, const ValueType& value,
                           bool mayInsert, bool mayUpdate)
{
    Node* p = find(key);
